            ...
            <div class="bg-white border border-gray-200 rounded-3xl shadow-sm overflow-hidden">
                ...
                <div class="border-b border-gray-100 p-8 bg-gray-50/50">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-950">Buat User Baru</h1>
                            <p class="text-gray-500 text-sm mt-1">Tambahkan pengguna baru (Admin, Lecturer, atau Student) ke sistem PintarKan.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select id="role" name="role"
                                        ...
                                        <option value="student" {{ old('role') === 'student' ? 'selected' : '' }}>Student (Mahasiswa)</option>
                                    </select>
                                    @error('role')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="flex gap-4 pt-6">
                            <button type="submit"
                                ...
                                <i class="fa-solid fa-user-plus mr-1"></i> Buat User
                            </button>
