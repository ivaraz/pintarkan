    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-4xl mx-auto px-6 lg:px-8 py-8">
                    ...
                    <div class="flex items-start gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 mt-3 text-base">
                                ...
                                Buat mata kuliah baru yang akan Anda ampu.
            ...
            <div class="bg-white border border-gray-200 rounded-3xl shadow-sm overflow-hidden">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 mt-1">
                                ...
                                Lengkapi informasi berikut untuk membuat course baru.
                ...
                {{-- Form --}}
                <form action="{{ route('lecturer.courses.store') }}" method="POST" class="p-8 space-y-8">
