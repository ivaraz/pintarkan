    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-5xl mx-auto px-6 lg:px-8 py-8">
                    ...
                    <div class="flex items-start gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 mt-3 text-base">
                                ...
                                Buat materi baru untuk mahasiswa pada mata kuliah
            ...
            <div class="bg-white border border-gray-200 rounded-3xl shadow-sm overflow-hidden">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 mt-1">
                                ...
                                Lengkapi informasi berikut untuk membuat materi baru.
                ...
                {{-- Form --}}
                <form action="{{ route('lecturer.materials.store', $course) }}" method="POST" enctype="multipart/form-data"
                    class="p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <textarea id="content" name="content" rows="7" placeholder="Tuliskan isi materi di sini..."
                            ...
                            @error('content') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror">{{ old('content') }}</textarea>
